...
$string['checkforactivity'] = 'Check for activity, changes may take a while';
...
$string['sincecoursestart'] = 'Since course start';
$string['showbackground'] = 'Show block color only';
$string['showboth'] = 'Show both block and count icons';
$string['showicons'] = 'Show count icons only';
$string['oneDay'] = 'From yesterday';
$string['twoDays'] = 'Two days ago';
$string['oneWeek'] = 'Week ago';
$string['twoWeeks'] = 'Two weeks ago';
$string['month'] = 'A month ago';
$string['sinceforever'] = 'All past logs';
$string['sincestart'] = 'Since course start';
